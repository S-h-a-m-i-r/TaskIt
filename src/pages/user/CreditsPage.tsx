...
import PaymentForm from "../../components/generalComponents/PaymentForm";
...
const CreditsPage = () => {
	...
	const {available, fetchCredits} = useCreditsStore();
      ...
      <div className="flex max-md:flex-col gap-10 w-full justify-between">
        ...
        <div className="md:max-w-[425px] h-[627px] w-full p-9 relative bg-white rounded-md flex flex-col justify-between overflow-hidden">
          <div className="flex items-center">
            <p
              className={`text-[128px] font-normal ${
                available < 10 ? "text-primary-500" : "text-primary-50"
              }`}
            >
              {available}
            </p>
          ...
          <div>
            <div className="relative z-10 flex flex-col gap-4 mb-6">
              <h2 className="text-[36px] text-left font-semibold text-gray-600">
                Get Monthly
              </h2>
              ...
              <button className="z-20 bg-primary-50 text-white w-full rounded-full p-2 mt-2 ">
                Buy Now
              </button>
            </div>
            <img
              src={credits}
              className="absolute bottom-[-20px] right-[-10px] max-h-[550px] z-0"
            />
          </div>
        </div>
      </div>
