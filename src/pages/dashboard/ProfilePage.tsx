				...
				<div className="mb-6">
					...
					<div className="flex items-center border rounded-md px-3 py-2 focus-within:ring-0">
						...
						<div onClick={toggleConfirmPassword}>
							{" "}
							{showPassword.confirmPassword ? <IoEyeOffOutline /> : <IoEyeOutline />}
						</div>
					</div>
				</div>

				<button className="w-full bg-primary-50 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
					Update
				</button>
			</div>
		</div>
