  ...
  return (
    <aside className="w-60 bg-white dark:bg-black py-4 flex flex-col relative ">
      ...
      <div className='absolute bottom-10 left-3'>
        <div className=' mt-20 max-w-[216px] max-lg:max-w-[150px] w-full justify-self-center flex flex-col justify-end p-3 rounded-lg h-[187px] bg-[#F3F4F6] dark:bg-[#282828] dark:border dark:border-[#4B5563] relative overflow-hidden'>
