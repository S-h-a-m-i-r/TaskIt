		...
		<div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
			<div className="max-w-4xl mx-auto">
				...
				<div className="w-full">
					<button
						className="w-full text-[12px] py-4 bg-primary-50 hover:bg-primary-200 text-white rounded-full font-medium text-lg shadow-lg hover:shadow-xl transition-all duration-200"
						onClick={handleclick}
					>
						Continue
					</button>
